...
image:https://gitlab.com/KitaitiMakoto/epub-parser/badges/master/coverage.svg[link="https://gitlab.com/KitaitiMakoto/epub-parser/commits/master",title="coverage report"]

* http://www.rubydoc.info/gems/epub-parser/file/docs/Home.markdown[Homepage]
* http://www.rubydoc.info/gems/epub-parser[Documentation]
...
See document's {file:docs/Home.markdown} or http://www.rubydoc.info/gems/epub-parser[API Documentation] for more info.
...
Documentation is available in http://www.rubydoc.info/gems/epub-parser/file/docs/Home.markdown[homepage].
